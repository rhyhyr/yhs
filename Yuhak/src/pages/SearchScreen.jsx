  ...
  return (
    <>
      ...
      <div className="scroll-area" style={{ paddingBottom: '12px' }}>
        ...
        {/* 결과 없을 때 안내 (조건부 렌더링 자리) */}
        {/* 결과가 없을 경우:
        <div style={{ margin: '24px 14px', padding: '20px', border: '1.5px dashed var(--c-border)', borderRadius: '13px', textAlign: 'center' }}>
          <div style={{ fontSize: '28px', marginBottom: '8px' }}>🔍</div>
          <div style={{ fontSize: '14px', fontWeight: 600, color: 'var(--c-t1)', marginBottom: '4px' }}>저장된 답변이 없어요</div>
          <div style={{ fontSize: '12px', color: 'var(--c-t2)', marginBottom: '14px' }}>채팅 탭에서 먼저 질문해보세요</div>
          <button className="qa-btn" style={{ width: '100%' }} onClick={() => navigate('s-main')}>💬 채팅 탭으로 이동</button>
        </div>
        */}
