...
from yhs.rag.crawler.web_search_client import WebSearchClient
...
def test_crawl_fallback_chunks_visits_all_allowed_site_roots_first(monkeypatch):
    ...
    monkeypatch.setattr("yhs.rag.crawler.web_search_client.CRAWL_MAX_PAGES", 3)
    monkeypatch.setattr("yhs.rag.crawler.web_search_client.CRAWL_MAX_DEPTH", 4)
    monkeypatch.setattr("yhs.rag.crawler.web_search_client.CRAWL_SLEEP_SEC", 0)
