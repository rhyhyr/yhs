...
INTENT_KEYWORDS: dict[str, list[str]] = {
    ...
    "life_admin": [
        ...
        "캠퍼스", "특성화",
        "공장", "건설", "건설현장", "제조업", "개인과외", "과외",
    ],
    "telecom": [
        "유심", "sim", "선불", "후불", "핸드폰", "휴대폰", "통신",
        "개통", "유선전화", "전화 개통", "휴대전화",
    ],
    "support": [
        "1345", "외국인종합안내센터", "콜센터", "통합콜센터",
        "통역", "법률 상담", "지원기관", "지원 센터",
        "부산외국인", "글로벌도시재단",
    ],
}
...
INTENT_ANCHORS: dict[str, list[str]] = {
    ...
    "academic": ["학사일정", "수강신청", "등록금", "휴학", "복학", "중간시험", "기말시험", "전자출결", "학점",
                 "장학금", "장학", "TOPIK", "성적 기준", "어학성적"],
    "dormitory": ["기숙사", "생활관", "한림생활관", "기숙사비", "호실"],
    "life_admin": ["출입국관리사무소", "주소 변경", "취업 허가", "시간제 취업", "픽업 서비스", "캠퍼스",
                   "공장", "건설현장", "개인과외"],
    "telecom": ["선불 유심", "후불 핸드폰", "유심 개통", "휴대전화 개통", "통신 요금제"],
    "support": ["1345 외국인종합안내센터", "부산 외국인 콜센터", "통역 상담"],
}
